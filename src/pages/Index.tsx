      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <button className="bg-white border-2 border-yanolja-primary text-yanolja-primary px-8 py-3 rounded-xl font-medium hover:bg-yanolja-primary hover:text-white transition-all duration-200">
              더 많은 숙소 보기
            </button>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-yanolja-light rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">즉시 예약 확정</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">특가 혜택</h3>
              <p className="text-gray-600">
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="text-2xl font-bold text-yanolja-primary mb-4">
                야놀자
              </div>
